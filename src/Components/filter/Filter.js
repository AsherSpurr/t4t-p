...
const Filter = ({ updateLocs, locs, setFilters, updateFilters }) => {
    ...
    return (
        <form className='Filter_div_wrapper' >
            {/* <div> */}
                <input type='checkbox' className='Filter_input' id='accessible' name='accessible' value={activeFilters.accessible} onChange={handleChange}/>
                <label for='accessible'>Accessible</label>
            {/* </div>
            <div> */}
                <input type='checkbox' className='Filter_input' id='unisex'name='unisex' value={activeFilters.unisex} onChange={handleChange}/>
                <label for='unisex'>Unisex</label>
            {/* </div>
            <div> */}
                <input type='checkbox' className='Filter_input' id='all' name='all' value={activeFilters.all} onChange={handleChange}/>
