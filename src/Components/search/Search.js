    ...
    return (
        <div className='Search_div_container'>
            ...
            <form className='Search_form'>
                ...
                <input className='Search_input' type='text' placeholder='Street address' name='street' value={street} onChange={(e) => setStreet(e.target.value)}></input>
                ...
                <input className='Search_input' type='text' placeholder='State' name='state' value={state} onChange={(e) => setState(e.target.value)}></input>
                <button className='Search_button' type='submit' onClick={(e) => fetchLatLonSearch(e, street, town, state, key)}>Search</button>
            </form>
        </div>
    )
}
